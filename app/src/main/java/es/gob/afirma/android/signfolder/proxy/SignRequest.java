...
public class  SignRequest {
	...
	/** Fecha de la caducidad de la petici&oacute;n. */
	 ...
	 * @param date Fecha.
	 * @param expirationDate Fecha de caducidad de la petici&oacute;n de firma.
	...
	public SignRequest(final String id,
					   ...
					   final RequestDocument[] attached) {
		this.id = id;
	...
	public String getExpirationDate() {
		if(this.expDate != null && !this.expDate.equalsIgnoreCase("null")) {
			return this.expDate;
		}
		return null;
	}
	...
	/** Recupera el listado de anexos de la petici&oacute;n de firma.
	 * @return Listado de documentos. */
	public RequestDocument[] getAttached() {
		if(this.attached == null) {
			return new RequestDocument[0];
		}
		else {
	 ...
	 */
	public void setExpDate(final String expirationDate) {
		this.expDate = expirationDate;
	}

	/**
	 * Establece el listado de documentos que hay que firmar.
	 ...
	 */
	public void setAttached(final RequestDocument[] attached) {
		this.attached = attached;
	}
