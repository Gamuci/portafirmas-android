...
public final class FileChooserActivity extends ListActivity {
	...
	static final int PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE = 201;
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		if (savedInstanceState != null && savedInstanceState.containsKey(SAVE_INSTANCE_KEY_INITIAL_DIR)) {
			...
			if (savedInstanceState.containsKey(SAVE_INSTANCE_KEY_CURRENT_DIR)) {
                String dirPath = savedInstanceState.getString(SAVE_INSTANCE_KEY_CURRENT_DIR);
				this.currentDir = dirPath != null ? new File(dirPath) : null;
			}
		}
	...
	private void fill(final File f) {
        ...
        FileArrayAdapter adapter = new FileArrayAdapter(FileChooserActivity.this, dir);
