...
public final class SelectAliasDialog extends DialogFragment {
	...
	public final class AppAdapter extends ArrayAdapter<CertificateInfoForAliasSelect>{
		...
		/**
		 * @param context Contexto en el que se ejecuta el adaptador.
		 * @param textViewResourceId Identificador del campo de aplicaci&oacute;n.
		 * @param items Listado de certificados.
		 */
		AppAdapter(final Context context, final int textViewResourceId,  final ArrayList<CertificateInfoForAliasSelect> items) {
		...
		public @NonNull View getView(final int position, final View convertView, @NonNull final ViewGroup parent) {
			...
			final RadioButton rd = v.findViewById(R.id.rdAlias);
	...
	public Dialog onCreateDialog(final Bundle savedInstanceState){
		...
		final ListView listView = view.findViewById(R.id.listViewListadoApp);
