...
final class XmlRequestsFactory {
	...
	static String createPostsignRequest(final TriphaseRequest[] requests) {
		if (requests == null) {
			throw new IllegalArgumentException("La lista de peticiones no puede ser nula"); //$NON-NLS-1$
		}
		final StringBuilder sb = new StringBuilder(XML_HEADER);
	...
	/**
	 * Crea el XML para la solicitud del listado de aplicaciones.
	 * @return XML de solicitud.
	 */
	static String createAppListRequest() {
    ...
    /**
     * Crea el XML de solicitud  para la consulta del estado de las notificaciones del usuario.
     * @return XML de solicitud.
     */
    public static String createRecoverNotificationStateRequest() {
    ...
    /**
     * Crea el XML de solicitud  para el cambio de estado de las notificaciones del usuario (de
     * activadas a desactivadas o viceversa).
     * @return XML de solicitud.
     */
    public static String createChangeStateNotificationRequest() {
        return XML_HEADER +
                "<rqtnotch/>";
    }
